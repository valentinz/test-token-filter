...
public class TestTokenFilterFactory extends AbstractTokenFilterFactory {
    ...
    @Inject
    public TestTokenFilterFactory(Index index, IndexSettingsService indexSettingsService, @Assisted String name, @Assisted Settings settings) {
    ...
    public TokenStream create(TokenStream tokenStream) {
        return new TestTokenFilter(tokenStream);
    }
